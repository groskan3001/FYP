  ...
  <main className="page about-page-modern">
    <div className="about-container">
      ...
      <div className="about-hero">
        ...
        <h1>Built for Bold Commerce</h1>
        <p className="hero-description">
          NEXUS pairs a React + Express + MongoDB stack with modern design to deliver fast, intuitive shopping experiences
          that delight customers and empower every business.
        </p>
      </div>
      ...
      <div className="about-content">
        ...
        <section className="about-section">
          ...
          <div className="section-text">
            <h2>Our Mission</h2>
            <p>
              We believe shopping should be more than a transaction—it should be an experience. NEXUS combines cutting-edge
              technology with bold design to create shopping journeys that feel fast, personal, and effortless at every touchpoint.
            </p>
          </div>
        </section>
        ...
        <section className="about-section tech-section">
          ...
          <div className="section-text">
            ...
            <p>
              NEXUS leverages the best technologies to deliver a premium experience. Our stack includes Vite-powered React apps
        ...
        <section className="about-cta">
          ...
          <p>Join thousands of satisfied customers who trust NEXUS for their shopping needs.</p>
          <button
            type="button"
