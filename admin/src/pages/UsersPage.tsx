  ...
  if (isLoading) {
    return (
      <div className="page-center">
        ...
        <p className="text-muted text-sm mt-4">Loading customers…</p>
      </div>
    );
  }
  ...
  return (
    <section>
      <div className="section-heading">
        <div>
          <p className="eyebrow text-secondary">Customers</p>
          <h3 className="text-display font-bold text-primary">Account directory</h3>
        </div>
      </div>
